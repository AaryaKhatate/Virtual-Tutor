...
const LoginForm = ({ onForgot, onSignup }) => (
  <form className="space-y-4">
    ...
    <button
      type="submit"
      className="w-full rounded-lg bg-gradient-to-r from-accentBlue to-accentPurple px-4 py-2 text-white shadow-lg hover:shadow-xl hover:shadow-accentBlue/25 transform hover:-translate-y-0.5 transition-all duration-200 active:scale-95"
    >
      Login
    </button>
